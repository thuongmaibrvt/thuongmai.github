...
function singleMap_moibaria() {
    var myLatLng = {
        lng: $('#singleMap_moibaria').data('longitude'),
        lat: $('#singleMap_moibaria').data('latitude'),
    };
    var single_map = new google.maps.Map(document.getElementById('singleMap_moibaria'), {
        zoom: 14,
        center: myLatLng,
        scrollwheel: false,
        zoomControl: false,
...
var single_map = document.getElementById('singleMap_moibaria');
if (typeof (single_map) != 'undefined' && single_map != null) {
    google.maps.event.addDomListener(window, 'load', singleMap_moibaria);
}
