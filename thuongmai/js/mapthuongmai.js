(function ($) {
    ...
    function mainMap() {
	    ...
	    //  Map Infoboxes ------------------
        var locations = [
            [locationData('#', 'https://wiki.thuongmai.blog/images/8/82/Itvtbadboy.jpg', 'Thương mại brvt', "Long Tâm Bà Rịa, VN", 'cafe-cat', "5", "5", "Bà Rịa"  ), 15.7939252, 105.9102589, 0 , 'https://wiki.thuongmai.blog/images/8/82/Itvtbadboy.jpg'],
        ];
	    //   Map Infoboxes end ------------------
